...
// LMB-themed gradient: dark ember → gold → amber → soft pink → transparent
const LMB_STOPS: Stop[] = [
  { offset: 0, color: "#17130d" }, // Dark base
  { offset: 0.15, color: "#2a1810" }, // Deep brown
  { offset: 0.35, color: "#6a3820" }, // Rich amber
  { offset: 0.55, color: "#c9a86a" }, // LMB Gold
  { offset: 0.72, color: "#e4d2aa" }, // Soft gold
  { offset: 0.85, color: "#8b6f47" }, // Muted bronze
  { offset: 1, color: "#17130d00" }, // Transparent dark
];
...
export interface RuixenGradientFooterProps extends React.HTMLAttributes<HTMLElement> {
